...
<NavLink to="home" smooth={true} duration={500} className='z-10 cursor-pointer'>
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div className='flex space-x-8'>
      <NavLink to="/" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-blue ">
        Home
      </NavLink>
      <NavLink to="/about" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-blue ">
        About
      </NavLink>
      <NavLink to="/services" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-blue">
        Services
      </NavLink>
      <NavLink to="/process" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-blue">
        Process
      </NavLink>
      <NavLink to="/clients" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-blue">
        Clients
      </NavLink>
